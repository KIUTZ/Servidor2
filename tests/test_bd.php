...
if ($conn->query($test_data) === TRUE) {
    echo "Dato usuario de prueba insertado con éxito.<br>";
...
if ($conn->query($test_data) === TRUE) {
    echo "Dato sonda de prueba insertado con éxito tabla sonda.<br>";
...
if ($conn->query($test_data) === TRUE) {
    echo "Dato medicion de prueba insertado con éxito". PHP_EOL."<br>";
    $sql = "SELECT * FROM sonda WHERE `id usuario` = 0";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
...
if ($conn->query($delete_test_data) === TRUE) {
    echo "Dato de prueba medicion eliminado con éxito". "<br>";
} else {
...
if ($conn->query($delete_test_data) === TRUE) {
    echo "Dato de prueba sonda eliminado con éxito". "<br>";
} else {
...
if ($conn->query($delete_test_data) === TRUE) {
    echo "Dato de prueba usuario eliminado con éxito". "<br>";
} else {
    echo "Error al eliminar el dato de prueba: " . $conn->error . "<br>";
}
